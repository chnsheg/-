...
set cached_ip [config_ip_cache -export -no_bom  -dir D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.runs/ila_0_synth_1 -new_name ila_0 -ip [get_ips ila_0]]
...
if { [catch {
  file copy -force D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.runs/ila_0_synth_1/ila_0.dcp D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.srcs/sources_1/ip/ila_0/ila_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.srcs/sources_1/ip/ila_0/ila_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.srcs/sources_1/ip/ila_0/ila_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.srcs/sources_1/ip/ila_0/ila_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.srcs/sources_1/ip/ila_0/ila_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.runs/ila_0_synth_1/ila_0_stub.v D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.srcs/sources_1/ip/ila_0/ila_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.runs/ila_0_synth_1/ila_0_stub.vhdl D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.srcs/sources_1/ip/ila_0/ila_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.runs/ila_0_synth_1/ila_0_sim_netlist.v D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.srcs/sources_1/ip/ila_0/ila_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.runs/ila_0_synth_1/ila_0_sim_netlist.vhdl D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.srcs/sources_1/ip/ila_0/ila_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.ip_user_files/ip/ila_0]} {
  catch { 
    file copy -force D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.srcs/sources_1/ip/ila_0/ila_0_stub.v D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.ip_user_files/ip/ila_0
  }
}

if {[file isdir D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.ip_user_files/ip/ila_0]} {
  catch { 
    file copy -force D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.srcs/sources_1/ip/ila_0/ila_0_stub.vhdl D:/FPGA/ARM_SPI/CortexM3_Eval/CortexM3_Eval.ip_user_files/ip/ila_0
  }
}
